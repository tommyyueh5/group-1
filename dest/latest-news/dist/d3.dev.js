...
!function (t, n) {
  ...
  var Ke,
      ...
      or = 0,
      ar = 0,
      ur = "object" == (typeof performance === "undefined" ? "undefined" : _typeof(performance)) && performance.now ? performance : Date,
      cr = "object" == (typeof window === "undefined" ? "undefined" : _typeof(window)) && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function (t) {
    setTimeout(t, 17);
  };
    ...
    function l() {
      if (r) {
        ...
        for (u = 0, i = new Array(f); u < s; ++u) {
          (c = t[u]).index = u, "object" != _typeof(c.source) && (c.source = Ea(l, c.source)), "object" != _typeof(c.target) && (c.target = Ea(l, c.target)), i[c.source.index] = (i[c.source.index] || 0) + 1, i[c.target.index] = (i[c.target.index] || 0) + 1;
        }
