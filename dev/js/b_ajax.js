window.addEventListener("load", function(){	
	...
	function showProducts(json){
		...
		for( let i in news_data){
	            html += `<div class="news_box col-sm-12 col-md-6 col-lg-6 col-xl-4 item forignal">
	...
	function getProducts(pageNo){
		...
		let url = `./PHP_program/b.php?pageNo=${pageNo}`;
		console.log(url);
...
// window.addEventListener("load", function(){	
	//----------------
		...
		function test(datas) {
			//獲取標籤區
			let International = document.querySelectorAll('.forignal');
